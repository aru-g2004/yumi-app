    ...
    if (view === 'initial') {
        return (
            <div className="max-w-4xl mx-auto py-12 px-6 animate-in fade-in zoom-in duration-700">
                <button onClick={onBack} className="flex items-center gap-2 text-white/80 font-black hover:text-white mb-12 transition-colors">
                ...
                <div className="bg-white rounded-[4rem] p-16 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 space-y-12">
                        <div className="space-y-4">
                            <span className="text-[20px] font-black uppercase tracking-[0.4em] text-rose-400 block">{user.studioName || 'Your'} Studio</span>
                            <h2 className="text-6xl font-black tracking-tighter text-stone-900 drop-shadow-sm">Ready to Build?</h2>
                            <p className="text-xl text-stone-500 font-light max-w-lg mx-auto leading-relaxed">
    ...
    return (
        <div className="max-w-5xl mx-auto py-12 px-6 animate-in slide-in-from-bottom-12 duration-700">
            <div className="flex items-center justify-between mb-12">
                <button onClick={() => setView('initial')} className="flex items-center gap-2 text-white/80 font-black hover:text-white transition-colors">
                ...
                <div className="flex items-center gap-3 px-6 py-3 bg-white rounded-full shadow-lg">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-stone-500">Design Phase</span>
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-[3.5rem] p-12 shadow-2xl space-y-10">
                        <div className="space-y-4">
                            ...
                            <input
                                ...
                                className="w-full bg-stone-50 border-2 border-stone-100 rounded-[2.5rem] px-10 py-7 text-2xl font-black outline-none focus:border-stone-300 focus:ring-8 ring-stone-50 transition-all shadow-inner text-stone-900 placeholder:text-stone-300"
                            />
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <textarea
                                ...
                                className="w-full h-48 bg-stone-50 border-2 border-stone-100 rounded-[2.5rem] px-10 py-7 text-lg font-bold outline-none focus:border-stone-300 focus:ring-8 ring-stone-50 transition-all shadow-inner resize-none text-stone-900 placeholder:text-stone-300"
                            />
                        </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    <h4 className="font-black text-xl text-stone-900">Advanced Options</h4>
                            ...
                            <div className="pt-12 space-y-10 animate-in slide-in-from-top-4 duration-500">
                                ...
                                <div className="space-y-6 pt-4">
                                    <div className="flex justify-between items-end px-2">
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-[10px] text-stone-300 font-medium">Select up to 8 colors for your collection</p>
                                        </div>
                                        <div className="flex items-center gap-2 bg-stone-50 px-4 py-2 rounded-full border border-stone-100">
                                            ...
                                            <span className="text-[9px] font-black text-stone-400">{(formData.colorScheme?.length || 0)}/8</span>
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="space-y-4">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-stone-50 border-2 border-stone-100 rounded-[1.5rem] px-6 py-4 text-xs font-bold outline-none focus:border-stone-300 transition-all shadow-inner text-stone-900 placeholder:text-stone-300"
                                        />
                                    </div>
                                    <div className="space-y-4">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full h-36 bg-stone-50 border-2 border-stone-100 rounded-3xl px-6 py-4 text-xs font-bold outline-none focus:border-stone-300 text-stone-900 placeholder:text-stone-300"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-[9px] text-stone-300 font-medium ml-2">This is where you can name the characters in your series. If left empty, it will be auto-generated.</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-stone-400 text-rose-400">Rare Characteristics</label>
                                        <input
                                            ...
                                            className="w-full bg-stone-50 border-2 border-stone-100 rounded-2xl px-6 py-4 text-xs font-bold text-stone-900 placeholder:text-stone-300"
                                        />
                                    </div>
                                    <div className="space-y-4">
                        ...
                        <div className="bg-white rounded-[3rem] p-10 text-stone-900 shadow-2xl space-y-8 overflow-hidden relative">
                            ...
                            <div className="space-y-6">
                                <div className="flex justify-between items-center py-4 border-b border-stone-100">
                                    ...
                                    <span className="font-black text-rose-500">500 Coins</span>
                                </div>
                                <div className="flex justify-between items-center py-4 border-b border-stone-100">
                                ...
                                <div className="space-y-3 pt-4">
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                        <div className="flex items-center gap-3 text-xs">
                                            ...
                                            <span className={formData.name ? 'text-stone-900' : 'text-stone-300'}>Series Title</span>
                                        </div>
                                        <div className="flex items-center gap-3 text-xs">
                                            ...
                                            <span className={formData.keywords ? 'text-stone-900' : 'text-stone-300'}>Vision & Keywords</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
