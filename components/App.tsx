...
const App: React.FC = () => {
    ...
    const executeBatchPurchase = async () => {
        ...
        try {
            ...
            for (let i = 0; i < purchaseQuantity; i++) {
                ...
                // Video will be generated on-demand in the unboxing component
                let videoUrl: string | undefined = def.videoUrl;
    ...
    const handleBuyAnother = async () => {
        ...
        try {
            ...
            // Video will be generated on-demand
            const videoUrl = def.videoUrl;
                    ...
                    <div className="space-y-16">
                        <section className="bg-stone-900 rounded-[3.5rem] p-20 text-white relative overflow-hidden shadow-2xl">
                            ...
                            <div className="relative z-10 max-w-2xl">
                                ...
                                <h2 className="text-7xl font-black mb-8 tracking-tighter leading-[0.9]">text-yellowuniverse.</h2>
                                <p className="text-white-xl mb-12 leading-relaxed font-light">Input a theme, and watch as we generate a full mystery series including packaging and unique characters.</p>
                    ...
                    <div className="space-y-16 py-10 animate-in fade-in slide-in-from-bottom-10 duration-1000">
                            ...
                            {state.currentTheme.characterDefinitions.map((char, i) => {
                                ...
                                return (
                                    <div key={i} className={`group relative bg-white rounded-[2.5rem] p-6 shadow-xl border transition-all duration-700 overflow-hidden ${isBuilding ? 'border-emerald-200 scale-105 shadow-emerald-100/50' : 'border-stone-50 opacity-90'}`}>
                                        ...
                                        <h3 className={`text-2xl font-black tracking-tight mb-2 transition-colors duration-500 ${isDone ? 'text-[#2a0029]' : 'text-stone-600'}`}>
                                            {char.name}
                                        </h3>
                        ...
                        {!isProducing && activeStep >= 6 && (
                            <div className="flex flex-col items-center pt-10 animate-in fade-in slide-in-from-bottom-5 duration-700">
                                ...
                                <p className="mt-6 text-stone-700 font-bold uppercase tracking-widest text-[10px]">Production Run Successful</p>
                            </div>
                        )}
                    </div>
                )}
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                                ...
                                <div className="lg:col-span-3 space-y-6">
                                    ...
                                    {relatedChars.length > 0 && (
                                        <div className="bg-white rounded-[3rem] p-8 shadow-2xl border border-stone-50">
                                            <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-stone-700 mb-6">From Same Series ({relatedChars.length})</h3>
